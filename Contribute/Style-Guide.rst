...
AAOS Docs Style Guide
========================

By `Austin Songer`_

This document provides an overview of how articles published on `docs.aaos.org <http://docs.aaos.org>`_ should be formatted. You can actually use this file, itself, as a template when contributing articles.
